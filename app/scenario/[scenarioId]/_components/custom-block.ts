...
Blockly.Blocks['stringOf'] = {
  ...
  Blockly.JavaScript['regexInput'] = function(block: Blockly.Block) {
  ...
  Blockly.JavaScript['simplebot'] = function(block: Blockly.Block) {
  ...
  Blockly.JavaScript['responceontext'] = function(block: Blockly.Block) {
  ...
  Blockly.JavaScript['stringOf'] = function(block: Blockly.Block) {
