            ...
            <div className="flex-row-reverse lg:flex">
                ...
                <div className="flex-1 flex flex-col justify-center gap-10 pt-14">
                    <div className="">
                        ...
                        <Badge className="m-2" variant="blue">Mobile</Badge>
                        <Badge className="m-2" variant="yellow">Mobile</Badge>
                        <Badge className="m-2" variant="red">Mobile</Badge>
                        <Badge className="m-2" variant="orange">Mobile</Badge>
                        <Badge className="m-2" variant="cyan">Mobile</Badge>
                    </div>
                    <div>
