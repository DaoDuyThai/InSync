    ...
    return (
        <div className="container">
            ...
            <div className="section pt-5 pb-5">
                ...
                <ul>
                    <li><strong>Automated Actions and Screen Capture:</strong> InSync requires permission to access your device&rsquo;s accessibility settings to perform automated actions and capture screen content as part of your task automation scripts. InSync does not store or transmit sensitive information captured during these processes unless explicitly saved by the user.</li>
            ...
            <div className="section pt-5 pb-5">
                ...
                <p className="pt-2">InSync uses Cloudinary to store and retrieve user-uploaded media files in the cloud, offering secure and reliable storage and access. Here&rsquo;s how we ensure your data is handled securely:</p>
                <ul>
                    <li><strong>Media File Storage:</strong> When you upload images, screenshots, or other media files to InSync, these files are securely transmitted to and stored in Cloudinary. Each file is encrypted both in transit (using HTTPS) and at rest within Cloudinary&rsquo;s storage servers, protecting your content from unauthorized access.</li>
                    <li><strong>Access Control:</strong> Media files are stored in a way that restricts access to only the user&rsquo;s account. No other user or third party can access your files unless you specifically choose to share them. Files uploaded to Cloudinary are linked to your unique account ID to maintain strict control over who can view or retrieve them.</li>
                    ...
                    <li><strong>Third-Party Privacy:</strong> Cloudinary, as a third-party service provider, operates under its own privacy policy regarding data handling. We recommend reviewing Cloudinary&rsquo;s Privacy Policy to understand their specific data protection practices. While InSync integrates with Cloudinary, we do not control or manage their data processing policies beyond the secure transmission and retrieval of your files.</li>
                </ul>
            ...
            <div className="section pt-5 pb-5">
                ...
                <ul>
                    <li><strong>Firebase:</strong> Firebase helps us understand user engagement, identify issues, and improve the app&rsquo;s performance. Firebase may collect anonymized usage data, such as app interactions and device information. For details on how Firebase handles your information, please refer to Firebase&rsquo;s Privacy Policy.</li>
                </ul>
            </div>

            <div className="section pt-5 pb-5">
                <h2 className="font-bold section pb-5">5. Data Retention (PP-5.01)</h2>
                <p className="pt-2">At InSync, we are committed to ensuring that your data is managed responsibly. Our data retention practices are designed to balance your needs for functionality with your right to privacy. Here&rsquo;s how we handle data retention:</p>
                <ul>
            ...
            <div className="section pt-5 pb-5">
                ...
                <p className="pt-2">If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, we encourage you to reach out to us. Your feedback is vital for us to maintain transparency and improve our services. Here&rsquo;s how you can contact us:</p>
